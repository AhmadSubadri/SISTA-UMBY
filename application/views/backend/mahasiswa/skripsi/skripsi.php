<div class="card-block col-sm-12">
	<div class="card">
		<blockquote class="blockquote mb-0">
          <p class="text-c-red"><b>Note.</b> Sebelum melakukan pengajuan judul & proposal pastikan sudah anda siapkan dan anda konsultasikan ke dosen akademik anda.</p>
      ...
      <?php if (count($CountThesisAcc) > 0):?>
        <div class="card-block" style="pointer-events: none; opacity: 0.4;">
            <form class="form-material">
                ...
                <button class="btn btn-sm waves-effect waves-light btn-primary"><i class="ti-save"></i>Upload pengajuan</button>
            </form>
        </div>
    <?php else:?>
