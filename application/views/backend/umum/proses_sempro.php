<div class="col-xl-12">
    <a href="<?= site_url('dsn/dashboard/pelaksanaan-sempro');?>" class="btn btn-mini"><i class="ti-back-left"></i>Kembali</a>
    <div class="card">
                        ...
                        <?php foreach($data as $row):?>
                            <li>
                                ...
                                <ul class="text-center">
                                    ...
                                    <?php else:?>
                                        <object data="<?=base_url('_uploads/submission/'.$row->nameStudent.'/'.$row->file);?>" width="100%" height="500"></object>
                                    <?php endif;?>
                                </ul>
                            </li>
                            <?php endforeach;?>
                        ...
                        <ul>
                            <li>
                             <div class="container">
                                <div class="row">
                                    <div class="col-md-12">
                                        <form action="<?php echo base_url('dsn/dashboard/save-feedback');?>" class="form-material" method="post">
                                            ...
                                            <br>
                                            <button type="submit" class="btn btn-mini btn-grd-primary btn-round btn-block"><i class="ti-save"></i> Save</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
