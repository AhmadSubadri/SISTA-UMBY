	...
	<div class="card">
		<div class="card-header">
			...
			<div class="card-header-right">
				<a href="" class="btn btn-mini btn-outline-primary" id="Modal-Tourist" data-toggle="modal" data-target="#modalTambahann">+ Tambah Download</a>
			</div>
		</div>
			...
			<div class="row">
				...
				<?php if(count($Data) != 0):?>
					<?php $i=1;foreach($Data as $announc):?>
						<div class="col-sm-12 col-xl-3 sub-title"><?= $announc->judul;?></div>
						<div class="col-sm-12 col-xl-5 sub-title">
							<?= $announc->deskripsi ;?>
						</div>
						<div class="col-sm-12 col-xl-2 sub-title">
							<a href="<?=base_url('_uploads/download/'.$announc->file);?>" target="_blank" class="btn btn-mini btn-outline-primary"><i class="ti-download"></i> Download</a>
						</div>
						<div class="col-sm-12 col-xl-2 sub-title">
							...
							<a href="<?= site_url('Download/delete-download/'.$announc->id);?>" class="btn btn-mini btn-outline-danger"><i class="ti-trash"></i>Delete</a>
						</div>
						...
						<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="editann<?= $announc->id;?>" aria-hidden="true">
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<?= form_open_multipart('Download/update-download/'.$announc->id); ?>
										<div class="modal-body">
											<div class="form-group row">
												...
												<div class="col-sm-11">
													...
													<input type="text" name="judul" class="form-control" value="<?= $announc->judul;?>">
												</div>
											</div>
											<div class="form-group row">
												<label class="col-sm-1 col-form-label">Deskripsi</label>
												<div class="col-sm-11">
													<textarea name="announcement" id="announcementedit" style="width: 100%;"><?= $announc->deskripsi;?></textarea>
												</div>
											</div>
											<div class="form-group row">
												...
												<div class="col-sm-11">
													...
													<?php if($announc->file != null):?>
														<object data="<?=base_url('_uploads/download/'.$announc->file);?>" width="300" height="150"></object>
													<?php else:?>
														<object data="<?=base_url('_uploads/download/no_image.jpg');?>" width="80" height="80"></object>
													<?php endif;?>
												</div>
											</div>
										</div>
										<div class="modal-footer">
											...
											<button type="submit" class="btn btn-mini btn-primary">Update download</button>
										</div>
									</form>
								</div>
							</div>
...
<div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" id="modalTambahann" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<?= form_open_multipart('Download/save-download'); ?>
			<div class="modal-body">
				<div class="form-group row">
					<label class="col-sm-1 col-form-label">Judul</label>
					<div class="col-sm-11">
			...
			<div class="modal-footer">
				<button type="button" class="btn btn-mini btn-secondary" data-dismiss="modal">Close</button>
				<button type="submit" class="btn btn-mini btn-primary">Save download</button>
			</div>
		</form>
	</div>
</div>
