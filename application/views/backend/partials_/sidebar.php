  ...
  <div class="pcoded-inner-navbar main-menu">
    <div class="main-menu-header">
      ...
      <div class="user-details">
        <span id="more-details"><?= $this->session->userdata('name');?><i
      ...
      <div class="main-menu-content">
        <ul>
          <li class="more-details">
            ...
            <a href="#!" data-target="#logoutmodal" data-toggle="modal"><i class="ti-layout-sidebar-left"></i>Logout</a>
          </li>
        </ul>
      </div>
      ...
      <ul class="pcoded-item pcoded-left-item">
        ...
        <li class="pcoded-hasmenu">
          ...
          <ul class="pcoded-submenu">
            <li class=" ">
              <a href="<?= site_url('dsn/dashboard/data-pengajuan-skripsi');?>" class="waves-effect waves-dark">
                <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Data pengajuan judul & proposal</span>
                <span class="pcoded-mcaret"></span>
              </a>
            </li>
            <li class=" ">
              <a href="<?= site_url('dsn/dashboard/data-sempro-skripsi');?>" class="waves-effect waves-dark">
                ...
                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Schedule & pelaksanaan sempro</span>
                <span class="pcoded-mcaret"></span>
              </a>
            </li>
            <li class=" ">
          ...
          <ul class="pcoded-submenu">
            <li class=" ">
              <a href="<?= site_url('dsn/dashboard/pelaksanaan-sempro');?>" class="waves-effect waves-dark">
                <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Data mahasiswa seminar proposal</span>
                <span class="pcoded-mcaret"></span>
              </a>
            </li>
          </ul>
        ...
        <li class="pcoded-hasmenu">
          ...
          <ul class="pcoded-submenu">
            <li class=" ">
              <a href="<?= site_url('mhs/dashboard/pengajuan-judul-skripsi');?>" class="waves-effect waves-dark">
                <span class="pcoded-micon"><i class="ti-layout-grid2-alt"></i></span>
                <span class="pcoded-mtext" data-i18n="nav.basic-components.alert">Pengajuan judul & proposal</span>
                <span class="pcoded-mcaret"></span>
              </a>
            </li>
            <li class=" ">
              <a href="<?= site_url('mhs/dashboard/data-sempro');?>" class="waves-effect waves-dark">
                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Pengumuman & hasil seminar proposal</span>
                <span class="pcoded-mcaret"></span>
              </a>
            </li>
            <li class=" ">
          ...
          <ul class="pcoded-submenu">
            ...
            <li class=" ">
              <a href="breadcrumb.html" class="waves-effect waves-dark">
                <span class="pcoded-micon"><i class="ti-angle-right"></i></span>
                <span class="pcoded-mtext" data-i18n="nav.basic-components.breadcrumbs">Pengumuman & bimbingan</span>
                <span class="pcoded-mcaret"></span>
              </a>
            </li>
            <li class=" ">
