            ...
            <?php else:?>
                <?php foreach($Mahasiswa as $issi):?>
                    <div class="text-center">
                        ...
                        <?php else:?>
                            <img src="<?php echo base_url('_uploads/profile/student/').$issi->image;?>" alt="user image" class="img-radius img-50 align-top m-r-15" width="50px" height="50px" align-center>
                        <?php endif;?><br><br>
                        <h4 class="mt-0"><?= $issi->fullname;?></h4>
                        <p class="text-center my-2">Start messaging with your student's</p>
                    </div>
                <?php endforeach;?>
            <?php endif;?>
        </div>
            ...
            <?php foreach($Mahasiswa as $mhs):?>
                ...
                <?php else:?>
                    <div class="form-inline">
                        ...
                        <textarea class="form-control" id="uploadFile" name="message" class="form-control form-bg-default" required style="width: 80%;"></textarea><input type="submit" style="background-color: white; border: none;" class="btn" value="Send">
                    </div>
                <?php endif;?>
            <?php endforeach;?>
            <?= form_close();?>
