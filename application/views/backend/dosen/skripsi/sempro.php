<div class="col-xl-12">
    <div class="card">
    	<div class="card-header-right">
			<a data-toggle="modal" data-target="#staticBackdrop" class="btn btn-mini text-danger"><i class="ti-help"></i>Help</a>
                    ...
                    <div class="accordion-panel">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                            <div class="accordion-content accordion-desc">
                            	<form action="<?php echo base_url('dsn/dashboard/ploting-dosen-sempro');?>" method="POST">
                            		<div class="form-group form-default">
		                               <div class="form-group form-default">
											<label for="namemhs">Nama Mahasiswa</label>
					                            ...
					                            <input type="text" id="namemhs" name="namemhs" class="form-control" placeholder="Nama Mahasiswa" required>
										</div>
										...
										<button type="submit" class="btn btn-primary btn-mini"><i class="ti-save"> Save</i></button>
									</div>
								</form>
                            </div>
                        </div>
					...
					<tbody>
						...
						<?php else:?>
							...
							<tr>
								...
								<td>
									<?php if($row->status_sempro == 0):?>
									<a href="<?php echo base_url('dsn/dashboard/jadwal-sempro-skripsi/'.$row->nim);?>" class="btn btn-mini text-custom"><i class="ti-pencil"></i>Jadwal sempro</a>
									<?php else:?>
										<a href="#" class="btn btn-mini disabled"><i class="ti-na"></i>Jadwal sempro</a>
									<?php endif;?>
									<a href="<?php echo base_url('dsn/dashboard/detail-hasil-sempro/'.$row->nim);?>" class="btn btn-mini btn-grd-info btn-info btn-outline-info"><i class="ti-eye"></i>Detail hasil</a>
								</td>
							</tr>
						<?php endforeach;?>
						<?php endif;?>
...
$(document).ready(function() {
    $('#namemhs').autocomplete({
        source: "<?= site_url('dsn/dashboard/autocom');?>",
